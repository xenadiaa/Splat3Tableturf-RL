...
from switch_connect.vision_capture.adapter import FFmpegCaptureSource, list_avfoundation_video_devices
from switch_connect.vision_capture.adapter import auto_detect_capture_device_name
from switch_connect.vision_capture.adapter import is_usb_capture_device_name
...
def _unique_image_path(out_dir: Path, prefix: str, idx: int) -> Path:
    ...
    return out_dir / f"{prefix}_{ts}_{idx:05d}.jpg"
...
def main() -> int:
    ...
    p.add_argument("--out-dir", default="switch_connect/vision_capture/debug")
